...
The root folder contains the Python launcher and the static website. The application package, examples, build scripts, screenshots, and metadata live inside `project/`.
...
- `download.html`: Static website download page.
- `styles.css`: Website styles.
- `script.js`: Website copy buttons and download URL.
- `assets/dsiforgemenu.png`: Website screenshot asset.
...
The static website lives at the root of the `DSiForge` folder:
